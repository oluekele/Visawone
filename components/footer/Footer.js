    ...
    <div className='flex flex-col lg:w-[80%] lg:mx-auto w-full px-6 lg:px-0 '>
      <div className='border-b-2 pb-6 lg:flex items-start justify-between'>
        ...
        <div className='flex flex-wrap justify-between mt-[30px] lg:w-[60%] lg:mt-0'>
          <div >
            <h2 className='font-medium  text-[24px] '>Company</h2>
            <ul className='flex-col items-center text-[18px]  font-medium '>
          ...
          <div >
            <h2 className='font-medium text-[24px] '>Quick Link</h2>
            <ul className='flex-col items-center  text-[18px]  font-medium '>
          ...
          <div className=' lg:w-[250px]'>
            <h2 className='font-medium text-[24px]'>Our Services</h2>
